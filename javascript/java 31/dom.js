...
// document.images[0].src="https://picsum.photos/200/300?grayscale";
...
//items.style.color="red"; // gives error
...
// create a new li before the first one - Natalie's solution
// let newList = document.createElement("li");
// let List = document.getElementById("items")
// List.insertBefore(newList,secondItem);
// newList.innerHTML = "new list text";
// console.log(newList);

// create new li befor the first one - Mansour's solution
