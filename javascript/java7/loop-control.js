// we print the numbers between 0 and 20 using while loop
let i =0;
while(i <= 20 ){
...
// we print the numbers between 0 and 100 multi 9
let c=0
while(c <= 100){
...
///////////////////////////////////////////////////////////////////
/*let drinkList=["water","tea","coffee","milk","cola","beer"];
let counter=-1;
...
/////////////////////////////////////////////////////////////////////////
// Using function to remove or filter out (cola) out of drinkList array

let drinkList=["water","tea","coffee","milk","cola","beer"];
let counter=-1;

function filterlist (filterdrink){
    while(counter < drinkList.length-1){

        counter++;
        if(drinkList[counter]==filterdrink){
            continue;
        }
